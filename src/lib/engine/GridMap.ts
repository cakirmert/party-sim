...
export class GridMap {
  ...
  static buildFromSpec(grid: GridSize, spec: BaseSpec): GridMap {
    ...
    // EXIT/ROAD should be fully walkable
    stamp(spec.exitRect, "EXIT", true, 1);
    // small ROAD hint: give same area a ROAD tag on perimeter if desired
    // (optional, we keep EXIT tag singular for logic simplicity)
